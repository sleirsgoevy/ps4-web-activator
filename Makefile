...
payload.elf: sdk/lib/lib.a main.c
	gcc -isystem sdk/freebsd-headers -nostdinc -nostdlib -fno-stack-protector -static sdk/lib/lib.a main.c libjbc/*.c -Wl,-gc-sections -o payload.elf -g -fPIC
...
payload.js: payload.bin
	python3 gen_mira_blob_2.py payload.bin > payload.js
